...
### Systems Administrator | Cloud Administrator | Identity, Endpoint, and Security Operations

---

## About Me

Systems administrator with hands-on experience in Microsoft 365 administration, identity and access management, endpoint support, cloud infrastructure, and technical documentation. Built a production-quality Azure project portfolio focused on identity governance, endpoint management, security monitoring, and automated response in Microsoft cloud environments. CompTIA A+ and Security+ certified.
...
Production-minded Microsoft Sentinel deployment with custom KQL detection engineering, incident investigation, automated response via Azure Logic Apps, and endpoint health reporting through Microsoft Graph PowerShell.  
[View Repository](https://github.com/EJCyber/Azure-Cloud-Security-Monitoring-and-Threat-Visibility)
...
Microsoft Azure, Microsoft Sentinel, Microsoft Entra ID, Microsoft Intune, Microsoft 365, Exchange Online, PowerShell, Microsoft Graph, Azure Logic Apps, KQL, Azure Virtual Network, Windows Server, CompTIA Security+
